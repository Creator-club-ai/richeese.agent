...
- `{vault}/06_wiki/wiki-schema.md`
- `{vault}/06_wiki/index.md`
- `{vault}/06_wiki/log.md`
...
1. `$RICHESSE_VAULT_PATH/06_wiki`
2. `%OneDrive%/문서/Obsidian Vault/richesse-content-os/06_wiki`
