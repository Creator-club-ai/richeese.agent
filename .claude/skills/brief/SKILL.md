---
name: brief
description: Use this skill when the user has approved an angle from the pitch skill and is ready to plan the slide structure. Turns the approved angle into a 4–7 slide skeleton — each slide's role, goal, and key point — then stops for user approval before handing off to the editor skill. Does NOT write copy or design notes.
---
...
2. 슬라이드 수를 정한다. 정보량이 적으면 억지로 늘리지 않는다. 4~7장.
...
- 경로: `C:/Users/dasar/OneDrive/문서/Obsidian Vault/richesse-content-os/03_brief/YYYY-MM-DD-[working-title].md`
